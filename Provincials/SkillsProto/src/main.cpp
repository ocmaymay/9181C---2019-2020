...
void pre_auton(void) {
  ...
  LeftMotor.setMaxTorque(80, pct);
  LeftMotor2.setMaxTorque(80, pct);
  RightMotor.setMaxTorque(80, pct);
  RightMotor2.setMaxTorque(80, pct);
...
static void deployCubes(void){
  ...
  static void drivingStraighter(double div){
      LeftMotor.spin(
          vex::directionType::fwd,
          ((Controller1.Axis3.position() + (Controller1.Axis4.position())/1.5) / div),
          vex::velocityUnits::pct);
      LeftMotor2.spin(
          vex::directionType::fwd,
          ((Controller1.Axis3.position() + (Controller1.Axis4.position())/1.5) / div),
  ...
  static void driving(double div){
      LeftMotor.spin(
          vex::directionType::fwd,
          (((Controller1.Axis3.position()/1.1) + Controller1.Axis4.position()) / div),
          vex::velocityUnits::pct);
      LeftMotor2.spin(
          vex::directionType::fwd,
