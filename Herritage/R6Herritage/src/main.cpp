...
Arm.spin(reverse);
wait(400, msec);
moveWithRotations(70,70,100,100);
moveWithRotations(27,27,900,900);
wait(100,msec);
...
moveWithRotations(30,70,500,300);
moveWithRotations(40,40,100,100);
wait(200, msec);
moveWithRotations(70,30,300,500);
  LeftMotor.setStopping(vex::brakeType::brake);
  LeftMotor2.setStopping(vex::brakeType::brake);
  RightMotor.setStopping(vex::brakeType::brake);
  RightMotor2.setStopping(vex::brakeType::brake);
...
wait(100,msec);
moveWithRotations(40,40,230,230);
wait(300,msec);
