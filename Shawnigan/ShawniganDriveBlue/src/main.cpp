...
moveWithRotations(70,70,450,450);
moveWithRotations(20,20,750,750);
wait(200,msec);
moveWithRotations(50,50,-550,-550);
stopIntake();
wait(400,msec);
moveWithRotations(30,30,370,-370);
wait(300,msec);
intakeSpdChange(15, 0);
moveWithRotations(40,40,380,380);
stopIntake();
wait(700,msec);
deployCubes();
}
